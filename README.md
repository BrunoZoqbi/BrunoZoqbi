...
Gestão de Projetos | Processos e Operações | Dados e IA aplicada à gestão
...
Atualmente utilizo o GitHub como base para construir um portfólio profissional voltado a projetos práticos relacionados à eficiência operacional, melhoria contínua, transformação digital, organização de processos e apoio à tomada de decisão.
...
- Controle e estruturação de informações  
- Apoio a projetos institucionais  
...
Este perfil está sendo estruturado para reunir projetos práticos relacionados a:
